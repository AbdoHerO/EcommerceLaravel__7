...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        ...
        <div class="x_content">
            <br>
            <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" action="{{URL('dashboard/productcategory') }}" method="POST">
                @csrf
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <input type="number" id="quantity_ctrl" name="quantity_ctrl" required="required" class="form-control">
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        ...
                        <input id="image_category" class="form-control" type="hidden" value="__imageCat.png" name="image_category">
                    </div>
                </div>
