                        ...
                        <div id="datatable_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap no-footer">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div><a href="{{URL('dashboard/productcategory/create ')}}"
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered dataTable no-footer"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                                    colspan="1" style="width: 215px;">Image Cat</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                                    colspan="1" style="width: 96px;">Brand Name</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                                    colspan="1" style="width: 44px;">Quantity Control</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                                    colspan="1" style="width: 88px;">Slug</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td><img src="{{ $procat->image_category }}"
                                                        style="width: 50px;height: 50px;" alt=""> </td>
                                                <td>{{ $procat->brand_name }}</td>
                                                <td>{{ $procat->quantity_ctrl }}</td>
                                                <td>{{ $procat->slug }}</td>
                                                <td>{{ $procat->status }}</td>
                                                <td>
                                                    <div class="col-md-6">
                                                        <div class="btn-group">
                                                            <form
                                                                action="{{URL('dashboard/productcategory/' . $procat->id . '/edit')}}"
                                                                method="get">
                                                                @csrf
                                                                <button type="submit"
                                                                    class="btn btn-secondary ml-1 mr-1">Edit</button>
                                                            </form>
                                                            {{--action="{{ route('productcategory.destroy', $procat->id) }}" --}}
                                                            <form  method="post" action="{{URL('dashboard/productcategory/' . $procat->id)}}">
                                                            ...
                                                            <form
                                                                action="{{URL('dashboard/productcategory/' . $procat->id)}}"
                                                                method="get">
